...
import { StyleSheet, Text, View, SafeAreaView, StatusBar, Image, ScrollView, FlatList, TouchableOpacity, SectionList } from 'react-native';

// DADOS PARA A TELA 1 (BOLOS DO FLÁVIO)
const destaquesData = [
...
const TelaBolos = () => (
  <View style={styles.screenContainer}>
    <ScrollView>
      <Image source={require('./assets/header-bolo.png')} style={styles.bolosHeaderImage} />
      <View style={styles.bolosContent}>
        <Text style={styles.bolosTitle}>Bolos do Flávio - Águas Claras</Text>
        <View style={styles.bolosInfoRow}>
          <Text>⭐ 4.9 (1 mil avaliações)</Text>
          <Text>• Nível 4</Text>
        </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.selectorContainer}>
        <TouchableOpacity onPress={() => setActiveScreen('Bolos')} style={[styles.selectorButton, activeScreen === 'Bolos' && styles.selectorActive]}>
          <Text style={styles.selectorText}>Tela 1: Bolos</Text>
        </TouchableOpacity>
